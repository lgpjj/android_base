 ...
 */
package com.lgpgit.open.finaldb.db.sqlite;
...
public class SqlBuilder {
	...
	public static SqlInfo buildClearSql(Class<?> clazz) {
		...
		SqlInfo sqlInfo = new SqlInfo();
		sqlInfo.setSql(getDeleteSqlBytableName(table.getTableName()));
