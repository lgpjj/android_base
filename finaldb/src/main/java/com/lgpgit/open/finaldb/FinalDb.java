 ...
 */
package com.lgpgit.open.finaldb;
...
import com.lgpgit.open.finaldb.db.sqlite.CursorUtils;
import com.lgpgit.open.finaldb.db.sqlite.DbModel;
import com.lgpgit.open.finaldb.db.sqlite.ManyToOneLazyLoader;
import com.lgpgit.open.finaldb.db.sqlite.OneToManyLazyLoader;
import com.lgpgit.open.finaldb.db.sqlite.SqlBuilder;
import com.lgpgit.open.finaldb.db.sqlite.SqlInfo;
import com.lgpgit.open.finaldb.db.table.KeyValue;
import com.lgpgit.open.finaldb.db.table.ManyToOne;
import com.lgpgit.open.finaldb.db.table.OneToMany;
import com.lgpgit.open.finaldb.db.table.TableInfo;
import com.lgpgit.open.finaldb.exception.DbException;
...
public class FinalDb {
	...
	public <T> List<T> findPage(Class<T> clazz, String strWhere, String orderBy, int pageNo, int pageSize) {
		
		if (pageNo < 1) {
			pageNo = 1; //从第一页开始
		}
		if (pageSize < 1) {
			pageSize = 1; // 每页的条数至少为1条
		}
		// 获取其实条数
		...
		**/
		...
		Cursor cursor = db.query(table.getTableName(), null, strWhere, null, null, null, orderBy, limit);
